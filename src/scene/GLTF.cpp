...
namespace matrix
{
	...
	namespace scene
	{
		...
		static UnorderedMap<String, GLTFType> types = {{"SCALAR", GLTFType::SCALAR}, {"VEC2", GLTFType::VEC2}, {"VEC3", GLTFType::VEC3}, {"VEC4", GLTFType::VEC4}, {"MAT2", GLTFType::MAT2}, {"MAT3", GLTFType::MAT3}, {"MAT4", GLTFType::MAT4}};
