...
namespace matrix
{
	...
	namespace scene
	{
		...
		Scene::Scene(Ref<graphics::DeviceInstance> device, const Array<RenderImplementationType> &renderImplementationTypes, u32 bufferCount) : renderImplementationTypes(renderImplementationTypes)
		{
