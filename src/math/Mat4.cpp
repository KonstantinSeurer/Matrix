...
{
	return x.x * ((y.y * z.z * w.w + y.z * z.w * w.y + y.w * z.y * w.z) - y.w * z.z * w.y - y.y * z.w * w.z - y.z * z.y * w.w)
	- x.y * ((y.x * z.z * w.w + y.z * z.w * w.x + y.w * z.x * w.z) - y.w * z.z * w.x - y.x * z.w * w.z - y.z * z.x * w.w)
	+ x.z * ((y.x * z.y * w.w + y.y * z.w * w.x + y.w * z.x * w.y) - y.w * z.y * w.x - y.x * z.w * w.y - y.y * z.x * w.w)
	- x.w * ((y.x * z.y * w.z + y.y * z.z * w.x + y.z * z.x * w.y) - y.z * z.y * w.x - y.x * z.z * w.y - y.y * z.x * w.z);
}
