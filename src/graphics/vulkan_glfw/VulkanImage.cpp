...
static UnorderedMap<ImageFormatType, VkImageAspectFlags> aspectMasks = { { ImageFormatType::COLOR, VK_IMAGE_ASPECT_COLOR_BIT }, { ImageFormatType::DEPTH,
	VK_IMAGE_ASPECT_DEPTH_BIT }, { ImageFormatType::DEPTH_STENCIL, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT }, { ImageFormatType::STENCIL,
