...
static UnorderedMap<String, ShaderType> shaderTypes = { { "vertexShader", ShaderType::VERTEX }, { "tesselationControlShader", ShaderType::TESSELATION_CONTROL },
	{ "tesselationEvaluationShader", ShaderType::TESSELATION_EVALUATION }, { "geometryShader", ShaderType::GEOMETRY },
	{ "fragmentShader", ShaderType::FRAGMENT }, { "computeShader", ShaderType::COMPUTE } };
...
static UnorderedMap<PrimitiveTypeType, String> primitiveTypeNames = { { PrimitiveTypeType::INT, "int" }, { PrimitiveTypeType::UINT, "uint" }, {
	PrimitiveTypeType::BOOL, "bool" }, { PrimitiveTypeType::FLOAT, "float" }, { PrimitiveTypeType::VEC2, "vec2" }, { PrimitiveTypeType::VEC3, "vec3" }, {
	PrimitiveTypeType::VEC4, "vec4" }, { PrimitiveTypeType::MAT2, "mat2" }, { PrimitiveTypeType::MAT3, "mat3" }, { PrimitiveTypeType::MAT4, "mat4" } };
...
#define ADD_PIPELINE(member) for (auto& m : pipeline->member) if (find(member.begin(), member.end(), m) == member.end()) member.push_back(m);
